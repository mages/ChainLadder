...
The Paid-incurred Chain model has been published by M.Wuthrich and M.Merz in 2010. It combines claims payments and incurred losses information in a a mathematically rigorous and consistent way to get a unified ultimate loss prediction.
...
\texttt{s.e.} is the square root of mean square error of prediction for the total reserve.
